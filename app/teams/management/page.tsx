...
const seniorCore = [
  { id: 1, name: 'Senior Core 1', position: 'Manager', image: '/photos/20762853-f930-46f7-84d0-2f23c6e4f373.jpg', defaultPos: { x: 0, y: 0, w: 4, h: 4 } },
  { id: 2, name: 'Senior Core 2', position: 'Operations Lead', image: '/photos/5a075dd4-e8f4-4734-b1f8-b0b1709b2aeb.jpg', defaultPos: { x: 4, y: 0, w: 4, h: 4 } },
  { id: 3, name: 'Senior Core 3', position: 'Coordinator', image: '/photos/60462c4f-82bb-4ed1-8efa-524485c96a7f.jpg', defaultPos: { x: 8, y: 0, w: 4, h: 4 } },
  { id: 4, name: 'Senior Core 4', position: 'Assistant', image: '/photos/683accf2-2b49-427b-95a8-d56ccfb1a276.jpg', defaultPos: { x: 0, y: 4, w: 4, h: 4 } },
]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative w-full h-screen bg-black">
        <CosmicParallaxBg 
          ...
          text="Strategic Planning and Operations"
          loop={true}
        />
        <motion.button
          onClick={() => router.back()}
