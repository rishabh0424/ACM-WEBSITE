...
const seniorCore = [
  { id: 1, name: 'Senior Core 1', position: 'Social Media Lead', image: '/photos/DSC_0163.JPG', defaultPos: { x: 0, y: 0, w: 4, h: 4 } },
  { id: 2, name: 'Senior Core 2', position: 'Content Creator', image: '/photos/DSC_0179.JPG', defaultPos: { x: 4, y: 0, w: 4, h: 4 } },
  { id: 3, name: 'Senior Core 3', position: 'Community Manager', image: '/photos/20762853-f930-46f7-84d0-2f23c6e4f373.jpg', defaultPos: { x: 8, y: 0, w: 4, h: 4 } },
  { id: 4, name: 'Senior Core 4', position: 'Engagement Lead', image: '/photos/5a075dd4-e8f4-4734-b1f8-b0b1709b2aeb.jpg', defaultPos: { x: 0, y: 4, w: 4, h: 4 } },
]
...
export default function SocialMediaTeamPage() {
