    ...
    useEffect(() => {
        ...
        class Star {
            ...
            draw() {
                ...
                ctx.lineTo(sx, sy);
                ctx.lineWidth = r * 2;
                ctx.strokeStyle = `rgba(255, 200, 100, ${1 - this.z / canvas.width})`;
                ctx.stroke();
            }
        }
        ...
        <div className="relative h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 text-center p-6">
                ...
                <motion.h1
                    ...
                    className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-orange-200 to-orange-600"
                >
                    Important Notice
                </motion.h1>
                ...
                >
                    Critical announcements and urgent updates from ACM Student Chapter
                </motion.p>
            </div>
        </div>
    );
...
export default ImportantNoticeHero;
